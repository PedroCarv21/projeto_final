...
export default function App() {
  ...
  const handleNavigate = (page: string, itemId?: string | number) => {
    setCurrentPage(page);
    if (page === "room-details" && typeof itemId === "string") {
      setSelectedRoomId(itemId);     // roomId = UUID
    } else if (page === "service-details" && typeof itemId === "number") {
      setSelectedServiceId(itemId);  // serviceId = int
    }
  };
